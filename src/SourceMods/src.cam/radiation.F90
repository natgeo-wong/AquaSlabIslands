...
logical :: use_rad_uniform_lat = .false. ! if true, use namelist specified latitude for coszrs calculation, longitude for coszrs calculation is set to 0 at all points
...
subroutine radiation_readnl(nlfile)
   ...
   namelist /radiation_nl/ iradsw, iradlw, irad_always, &
                           ...
                           use_rad_uniform_lat, rad_uniform_lat
   !-----------------------------------------------------------------------------
   ...
   call mpi_bcast(use_rad_uniform_lat, 1, mpi_logical, mstrid, mpicom, ierr)
   if (ierr /= 0) call endrun(sub//": FATAL: mpi_bcast: use_rad_uniform_lat")
   call mpi_bcast(rad_uniform_lat, 1, mpi_real8,  mstrid, mpicom, ierr)
   if (ierr /= 0) call endrun(sub//": FATAL: mpi_bcast: rad_uniform_lat")
